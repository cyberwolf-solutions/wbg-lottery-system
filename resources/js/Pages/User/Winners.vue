                        ...
                        <div v-for="winner in getWinners(lottery.dashboards)" :key="winner.id" class="winner-card">
                            ...
                            <div class="winner-details">
                                ...
                                <div class="winner-meta">
                                    <p><i class="bi bi-calendar"></i> {{ winner.dashboard.date }}</p>
                                    <p><i class="bi bi-ticket"></i> Draw #{{ winner.dashboard.draw_number }}</p>
                                    <p><i class="bi bi-trophy"></i> {{ winner.dashboard.dashboard }}</p>
                                    <p v-if="winner.dashboard.dashboardType"><i class="bi bi-info-circle"></i> {{
                                        winner.dashboard.dashboardType }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    data() {
        return {
            ...
            logoUrl1: '/assets/winners/default.jpg',
        };
    },
    methods: {
