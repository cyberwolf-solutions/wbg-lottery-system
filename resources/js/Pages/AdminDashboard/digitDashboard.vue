                    ...
                    <div class="modal-content">
                        ...
                        <form @submit.prevent="updateDashboard">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" v-model="editingDashboard.drawNumber" id="edit-draw-number"
                                    required />
                            </div>
...
export default {
    ...
    methods: {
        ...
        async createDashboard() {
            try {
                const response = await axios.post('/api/admin/digitdashboard/create', this.newDashboard);
