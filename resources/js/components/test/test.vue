        ...
        <div class="container-fluid mt-2 mb-3">
            <div class="row mx-5">
                ...
                <div class="hero-graphics d-flex justify-content-center mt-4 col-12 col-md-6">
                    <img :src="image1" alt="Lottery Graphics" class="img-fluid"
                    ...
                    <div class="team-boxed">
                        <div class="container ">
                            <div class="intro mt-4">
                                ...
                                <p class="text-center">Choose from the Powerball , Mega , Lotto or lucky Day <br> Lotto
                                    and
                            ...
                            <div class="row people align-items-center justify-content-center">
                                ...
                                <div class="card-wrapper item col-md-4 col-lg-3"
                                    ...
                                    <div
                                        class="card-box d-flex flex-column justify-content-center align-items-center text-center py-4">
                                        <img class="card-logo rounded-circle mb-3" :src="image2" style="height: 80px;"
                                            alt="Logo">
                                ...
                                <div class="card-wrapper item col-md-4 col-lg-3"
                                    ...
                                    <div
                                        class="card-box d-flex flex-column justify-content-center align-items-center text-center py-4">
                                        <img class="card-logo rounded-circle mb-3" :src="image3" style="height: 80px;"
                                            alt="Logo">
                                ...
                                <div class="card-wrapper item col-md-4 col-lg-3"
                                    ...
                                    <div
                                        class="card-box d-flex flex-column justify-content-center align-items-center text-center py-4">
                                        <img class="card-logo rounded-circle mb-3" :src="image4" style="height: 80px;"
                                            alt="Logo">
                        ...
                        <div class=" row align-content-center justify-content-center">
                            <div class="col-12 col-md-12">
                                <div class="intro mt-5">
                                    ...
                                    <p class="text-center text-secondary">Check your lotto results online, find all the
                                        lotto winning
                                        numbers
                                                ...
                                                <table class="table align-middle" style="border-style: none;">
                                                    ...
                                                    <tbody>
                                                        <tr style="background-color: #EEEEEE;">
                                                            <td>
                                                                <i class="bi bi-heart-fill text-danger me-2"></i> Cancer
                                                                Charity
                                                            </td>
                                                            <td>30/05/2018</td>
                                                            <td>890</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <i class="bi bi-flag-fill text-primary me-2"></i> US
                                                                Powerball
                                                            </td>
                                                            <td>30/05/2018</td>
                                                            <td>890</td>
                                            ...
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item d-flex justify-content-between align-items-center"
                                                    ...
                                                    <div>
                                                        ...
                                                        <small class="d-block text-muted">Cancer Charity,
                                                            30/05/2018</small>
                                                    </div>
