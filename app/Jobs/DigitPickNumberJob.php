...
use App\Models\User;
use App\Events\DigitNumberPicked;
...
class DigitPickNumberJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $pickedNumber = DigitPickedNumber::where('digit_lottery_dashboard_id', $this->lotteryDashboardId)
        ...
        broadcast(new DigitNumberPicked($pickedNumber))->toOthers();
